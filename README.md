...
First, clone this repo and [pycocoevalcap](https://github.com/dawggodawgs/coco-caption.git) in same directory.

```bash
$ git clone https://github.com/dawggodawgs/show-attend-and-tell.git
$ git clone https://github.com/dawggodawgs/coco-caption.git
```
